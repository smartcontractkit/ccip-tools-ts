...
export default defineConfig(
  {
    ignores: [
      ...
      // Generated by `docusaurus gen-api-docs` (per workspace) from the hand-written
      // sidebar.ts templates; the tracked .d.ts siblings stay linted.
      'ccip-api-ref/docs-api/**/*.js',
      'ccip-api-ref/docs-api/**/*.js.map',
