...
export default defineConfig(
  ...
  },
  {
    ...
    // and /src/cct/*/index.ts (heavy deps kept out of the main barrel).
    files: ['ccip-cli/src/**/*.ts'],
    rules: {
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            {
              regex:
                '^(?!@chainlink/ccip-sdk/src/index\\.ts$|@chainlink/ccip-sdk/src/cct/[^/]+/index\\.ts$).*\\/ccip-sdk\\b',
              message:
                'Import from @chainlink/ccip-sdk/src/index.ts or @chainlink/ccip-sdk/src/cct/*/index.ts instead of other modules.',
            },
          ],
        },
      ],
