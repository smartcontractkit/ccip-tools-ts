/** FactoryBurnMintERC20 ABI — auto-generated from chainlink-ccip gethwrapper. */
export default [
  // generate:
  // fetch('https://raw.githubusercontent.com/smartcontractkit/chainlink-ccip/release/contracts-ccip-1.6.2/chains/evm/gobindings/generated/v1_6_2/factory_burn_mint_erc20/factory_burn_mint_erc20.go')
  //   .then((res) => res.text())
  ...
  },
  {
    ...
    inputs: [{ name: 'burner', type: 'address', indexed: true, internalType: 'address' }],
    anonymous: false,
  },
  {
    type: 'event',
  ...
  },
  {
    ...
    inputs: [{ name: 'minter', type: 'address', indexed: true, internalType: 'address' }],
    anonymous: false,
  },
  {
    type: 'event',
