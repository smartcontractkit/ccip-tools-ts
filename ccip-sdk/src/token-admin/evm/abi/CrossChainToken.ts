// TODO: track a v2 release tag and the v2.0.0 folder instead of refs/heads/main, once 2.0.0 is released in `chainlink-ccip`
export default [
  // generate:
  // fetch('https://github.com/smartcontractkit/chainlink-ccip/raw/refs/heads/main/chains/evm/gobindings/generated/v2_0_0/cross_chain_token/cross_chain_token.go')
  //   .then((res) => res.text())
    ...
    inputs: [
      {
        name: 'args',
        type: 'tuple',
        internalType: 'struct BaseERC20.ConstructorParams',
        components: [
  ...
  },
  {
    ...
    name: 'getCCIPAdmin',
    inputs: [],
    outputs: [{ name: 'ccipAdmin', type: 'address', internalType: 'address' }],
    stateMutability: 'view',
  },
  {
    type: 'function',
  ...
  },
  {
    ...
    name: 'maxSupply',
    inputs: [],
    outputs: [{ name: '_maxSupply', type: 'uint256', internalType: 'uint256' }],
    stateMutability: 'view',
  },
  {
    type: 'function',
