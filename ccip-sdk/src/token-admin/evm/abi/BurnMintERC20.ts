/** BurnMintERC20 ABI — auto-generated from chainlink-evm gethwrapper. */
export default [
  // generate:
  // fetch('https://raw.githubusercontent.com/smartcontractkit/chainlink-evm/contracts-solidity/1.5.1/gethwrappers/shared/generated/latest/burn_mint_erc20/burn_mint_erc20.go')
  //   .then((res) => res.text())
  ...
  },
  {
    ...
    inputs: [{ name: 'burnAndMinter', type: 'address', internalType: 'address' }],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
  ...
  },
  {
    ...
    inputs: [{ name: 'supplyAfterMint', type: 'uint256', internalType: 'uint256' }],
  },
] as const
