export default [
  // generate:
  // (() => {
  //   const abi = require('@chainlink/contracts-ccip/abi/v1_5_0/token_admin_registry.json')
  //   return require('util').inspect(Array.isArray(abi) ? abi : abi.abi, { depth: 99 }).split('\n').slice(1, -1)
  // })()
  {
    type: 'function',
    name: 'acceptAdminRole',
    inputs: [{ name: 'localToken', type: 'address', internalType: 'address' }],
    outputs: [],
  ...
  },
  {
    ...
    inputs: [
      { name: 'startIndex', type: 'uint64', internalType: 'uint64' },
      { name: 'maxCount', type: 'uint64', internalType: 'uint64' },
    ],
