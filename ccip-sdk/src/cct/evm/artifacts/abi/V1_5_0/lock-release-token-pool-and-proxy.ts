export default [
  // generate:
  // (() => {
  //   const abi = require('@chainlink/contracts-ccip/abi/v1_5_0/lock_release_token_pool_and_proxy.json')
  ...
  },
  {
    ...
    inputs: [
      {
        indexed: false,
        internalType: 'contract IPoolPriorTo1_5',
        name: 'oldPool',
        type: 'address',
      },
      {
