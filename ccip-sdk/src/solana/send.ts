...
/** Converts an SDK message into the router's `SVM2AnyMessage` instruction argument. */
export function anyToSvmMessage(
  message: AnyMessage,
): IdlTypes<typeof CCIP_ROUTER_IDL>['SVM2AnyMessage'] {
