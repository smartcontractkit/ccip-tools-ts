export default [
  // generate:
  // fetch('https://github.com/smartcontractkit/chainlink-ccip/raw/refs/heads/main/chains/evm/gobindings/generated/v1_5_1/factory_burn_mint_erc20/factory_burn_mint_erc20.go')
  //   .then((res) => res.text())
  ...
  },
  {
    type: 'function',
    name: 'grantBurnRole',
    inputs: [{ name: 'burner', type: 'address', internalType: 'address' }],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
