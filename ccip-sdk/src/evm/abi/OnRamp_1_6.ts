export default [
  // generate:
  // fetch('https://github.com/smartcontractkit/chainlink/raw/refs/heads/release/contracts-ccip-1.6.0/core/gethwrappers/ccip/generated/onramp/onramp.go')
  //   .then((res) => res.text())
    ...
    inputs: [
      {
        name: 'staticConfig',
        type: 'tuple',
        internalType: 'structOnRamp.StaticConfig',
        components: [
          {
            name: 'chainSelector',
            type: 'uint64',
      ...
      },
      {
        name: 'dynamicConfig',
        type: 'tuple',
        internalType: 'structOnRamp.DynamicConfig',
        components: [
          {
            name: 'feeQuoter',
            type: 'address',
      ...
      },
      {
        ...
        type: 'tuple[]',
        internalType: 'structOnRamp.DestChainConfigArgs[]',
        components: [
          {
    ...
    inputs: [
      {
        ...
        type: 'tuple[]',
        internalType: 'structOnRamp.AllowlistConfigArgs[]',
        components: [
          {
            name: 'destChainSelector',
            type: 'uint64',
  ...
  },
  {
    ...
    outputs: [{ name: '', type: 'address', internalType: 'contractIPoolV1' }],
    stateMutability: 'view',
  },
  {
    type: 'function',
  ...
  },
  {
    ...
    inputs: [
      ...
      },
      {
        ...
        type: 'tuple',
        indexed: false,
        internalType: 'structInternal.EVM2AnyRampMessage',
        components: [
          {
            name: 'header',
            type: 'tuple',
