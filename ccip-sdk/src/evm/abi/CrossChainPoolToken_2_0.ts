export default [
  // generate:
  // fetch('https://github.com/smartcontractkit/chainlink-ccip/raw/refs/heads/main/chains/evm/gobindings/generated/v2_0_0/cross_chain_pool_token/cross_chain_pool_token.go')
  //   .then((res) => res.text())
