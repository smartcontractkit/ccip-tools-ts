export default [
  // generate:
  // fetch('https://github.com/smartcontractkit/chainlink-ccip/raw/refs/heads/main/chains/evm/gobindings/generated/v1_6_0/siloed_lock_release_token_pool/siloed_lock_release_token_pool.go')
  //   .then((res) => res.text())
  ...
  },
  {
    ...
    inputs: [
      { name: 'removes', type: 'uint64[]', internalType: 'uint64[]' },
      {
        name: 'adds',
        type: 'tuple[]',
        internalType: 'structSiloedLockReleaseTokenPool.SiloConfigUpdate[]',
        components: [
          {
            name: 'remoteChainSelector',
            type: 'uint64',
