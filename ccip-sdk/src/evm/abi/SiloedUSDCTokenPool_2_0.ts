export default [
  // generate:
  // fetch('https://github.com/smartcontractkit/chainlink-ccip/raw/refs/heads/main/chains/evm/gobindings/generated/v2_0_0/siloed_usdc_token_pool/siloed_usdc_token_pool.go')
  //   .then((res) => res.text())
  ...
  {
    type: 'function',
    name: 'cancelExistingCCTPMigrationProposal',
    inputs: [],
    outputs: [],
    stateMutability: 'nonpayable',
  },
    ...
    inputs: [
      {
        name: 'lockBoxConfigs',
        type: 'tuple[]',
        internalType: 'struct SiloedLockReleaseTokenPool.LockBoxConfig[]',
        components: [
          {
            name: 'remoteChainSelector',
            type: 'uint64',
  ...
  {
    type: 'function',
    name: 'getCurrentProposedCCTPChainMigration',
    inputs: [],
  ...
  },
  {
    ...
    outputs: [{ name: '', type: 'address', internalType: 'contract ILockBox' }],
    stateMutability: 'view',
  },
  {
    type: 'function',
    name: 'getLockedUSDCToBurn',
    inputs: [],
    outputs: [
      {
        name: 'lockedUSDCToBurn',
        type: 'uint256',
  ...
  },
  {
    ...
    inputs: [
      ...
      {
        name: 'burnableAmountAfterExclusion',
        type: 'uint256',
        indexed: false,
        internalType: 'uint256',
      },
