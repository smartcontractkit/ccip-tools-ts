export default [
  // generate:
  // fetch('https://github.com/smartcontractkit/chainlink-ccip/raw/refs/heads/main/chains/evm/gobindings/generated/v2_0_0/cctp_through_ccv_token_pool/cctp_through_ccv_token_pool.go')
  //   .then((res) => res.text())
