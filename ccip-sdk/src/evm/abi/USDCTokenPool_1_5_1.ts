export default [
  // generate:
  // fetch('https://github.com/smartcontractkit/chainlink-ccip/raw/refs/heads/main/chains/evm/gobindings/generated/v1_5_1/usdc_token_pool/usdc_token_pool.go')
  //   .then((res) => res.text())
    ...
    inputs: [
      {
        name: 'tokenMessenger',
        type: 'address',
        internalType: 'contractITokenMessenger',
      },
      {
        name: 'token',
        type: 'address',
    ...
    outputs: [
      {
        name: '',
        type: 'tuple',
        internalType: 'structUSDCTokenPool.Domain',
        components: [
          {
            name: 'allowedCaller',
            type: 'bytes32',
    ...
    outputs: [
      {
        name: '',
        type: 'address',
        internalType: 'contractIMessageTransmitter',
      },
    ],
    stateMutability: 'view',
  },
