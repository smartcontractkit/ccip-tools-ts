...
export const CCIPErrorCode = {
  ...
  // Finality
  FINALITY_NOT_ALLOWED: 'FINALITY_NOT_ALLOWED',

  // Attestation (USDC/LBTC)
  USDC_ATTESTATION_FAILED: 'USDC_ATTESTATION_FAILED',
  USDC_BURN_FEES_FAILED: 'USDC_BURN_FEES_FAILED',
  ...
  /** @deprecated Deprecated in v1.7 (2026-05-25). Use LOG_DATA_INVALID instead. */
  ...
  LOG_RANGE_TOO_LARGE: 'LOG_RANGE_TOO_LARGE',
  ...
  SOLANA_SIMULATION_NO_RETURN_DATA: 'SOLANA_SIMULATION_NO_RETURN_DATA',
  ...
  /** @deprecated Deprecated in v1.7 (2026-05-25). Use HASHER_VERSION_UNSUPPORTED instead. */
  ...
  // Token Deployment
  TOKEN_DEPLOY_PARAMS_INVALID: 'TOKEN_DEPLOY_PARAMS_INVALID',
  TOKEN_DEPLOY_FAILED: 'TOKEN_DEPLOY_FAILED',

  // Pool Deployment
  POOL_DEPLOY_PARAMS_INVALID: 'POOL_DEPLOY_PARAMS_INVALID',
  POOL_DEPLOY_FAILED: 'POOL_DEPLOY_FAILED',
  POOL_NOT_INITIALIZED: 'POOL_NOT_INITIALIZED',

  // Propose Admin Role
  PROPOSE_ADMIN_ROLE_PARAMS_INVALID: 'PROPOSE_ADMIN_ROLE_PARAMS_INVALID',
  PROPOSE_ADMIN_ROLE_FAILED: 'PROPOSE_ADMIN_ROLE_FAILED',

  // Accept Admin Role
  ACCEPT_ADMIN_ROLE_PARAMS_INVALID: 'ACCEPT_ADMIN_ROLE_PARAMS_INVALID',
  ACCEPT_ADMIN_ROLE_FAILED: 'ACCEPT_ADMIN_ROLE_FAILED',

  // Transfer Admin Role
  TRANSFER_ADMIN_ROLE_PARAMS_INVALID: 'TRANSFER_ADMIN_ROLE_PARAMS_INVALID',
  TRANSFER_ADMIN_ROLE_FAILED: 'TRANSFER_ADMIN_ROLE_FAILED',

  // Apply Chain Updates
  APPLY_CHAIN_UPDATES_PARAMS_INVALID: 'APPLY_CHAIN_UPDATES_PARAMS_INVALID',
  APPLY_CHAIN_UPDATES_FAILED: 'APPLY_CHAIN_UPDATES_FAILED',

  // Append Remote Pool Addresses
  APPEND_REMOTE_POOL_ADDRESSES_PARAMS_INVALID: 'APPEND_REMOTE_POOL_ADDRESSES_PARAMS_INVALID',
  APPEND_REMOTE_POOL_ADDRESSES_FAILED: 'APPEND_REMOTE_POOL_ADDRESSES_FAILED',

  // Delete Chain Config
  DELETE_CHAIN_CONFIG_PARAMS_INVALID: 'DELETE_CHAIN_CONFIG_PARAMS_INVALID',
  DELETE_CHAIN_CONFIG_FAILED: 'DELETE_CHAIN_CONFIG_FAILED',

  // Remove Remote Pool Addresses
  REMOVE_REMOTE_POOL_ADDRESSES_PARAMS_INVALID: 'REMOVE_REMOTE_POOL_ADDRESSES_PARAMS_INVALID',
  REMOVE_REMOTE_POOL_ADDRESSES_FAILED: 'REMOVE_REMOTE_POOL_ADDRESSES_FAILED',

  // Set Chain Rate Limiter Config
  SET_RATE_LIMITER_CONFIG_PARAMS_INVALID: 'SET_RATE_LIMITER_CONFIG_PARAMS_INVALID',
  SET_RATE_LIMITER_CONFIG_FAILED: 'SET_RATE_LIMITER_CONFIG_FAILED',

  // Set Rate Limit Admin
  SET_RATE_LIMIT_ADMIN_PARAMS_INVALID: 'SET_RATE_LIMIT_ADMIN_PARAMS_INVALID',
  SET_RATE_LIMIT_ADMIN_FAILED: 'SET_RATE_LIMIT_ADMIN_FAILED',

  // Provide Liquidity (lock-release pools)
  PROVIDE_LIQUIDITY_PARAMS_INVALID: 'PROVIDE_LIQUIDITY_PARAMS_INVALID',
  PROVIDE_LIQUIDITY_FAILED: 'PROVIDE_LIQUIDITY_FAILED',

  // Set Token Transfer Fee Config (EVM v2.0+ only)
  SET_TOKEN_TRANSFER_FEE_CONFIG_PARAMS_INVALID: 'SET_TOKEN_TRANSFER_FEE_CONFIG_PARAMS_INVALID',
  SET_TOKEN_TRANSFER_FEE_CONFIG_FAILED: 'SET_TOKEN_TRANSFER_FEE_CONFIG_FAILED',

  // Set Allowed Finality Config (EVM v2.0+ only)
  SET_ALLOWED_FINALITY_CONFIG_PARAMS_INVALID: 'SET_ALLOWED_FINALITY_CONFIG_PARAMS_INVALID',
  SET_ALLOWED_FINALITY_CONFIG_FAILED: 'SET_ALLOWED_FINALITY_CONFIG_FAILED',

  // Set Fee Admin (EVM v2.0+ only)
  SET_FEE_ADMIN_PARAMS_INVALID: 'SET_FEE_ADMIN_PARAMS_INVALID',
  SET_FEE_ADMIN_FAILED: 'SET_FEE_ADMIN_FAILED',

  // Create Pool Mint Authority Multisig (Solana-only)
  CREATE_POOL_MULTISIG_PARAMS_INVALID: 'CREATE_POOL_MULTISIG_PARAMS_INVALID',
  CREATE_POOL_MULTISIG_FAILED: 'CREATE_POOL_MULTISIG_FAILED',

  // Transfer Mint Authority (Solana-only)
  TRANSFER_MINT_AUTHORITY_PARAMS_INVALID: 'TRANSFER_MINT_AUTHORITY_PARAMS_INVALID',
  TRANSFER_MINT_AUTHORITY_FAILED: 'TRANSFER_MINT_AUTHORITY_FAILED',

  // Grant Mint/Burn Access
  GRANT_MINT_BURN_ACCESS_PARAMS_INVALID: 'GRANT_MINT_BURN_ACCESS_PARAMS_INVALID',
  GRANT_MINT_BURN_ACCESS_FAILED: 'GRANT_MINT_BURN_ACCESS_FAILED',

  // Revoke Mint/Burn Access
  REVOKE_MINT_BURN_ACCESS_PARAMS_INVALID: 'REVOKE_MINT_BURN_ACCESS_PARAMS_INVALID',
  REVOKE_MINT_BURN_ACCESS_FAILED: 'REVOKE_MINT_BURN_ACCESS_FAILED',

  // Create Pool Token Account (Solana-only)
  CREATE_POOL_TOKEN_ACCOUNT_PARAMS_INVALID: 'CREATE_POOL_TOKEN_ACCOUNT_PARAMS_INVALID',
  CREATE_POOL_TOKEN_ACCOUNT_FAILED: 'CREATE_POOL_TOKEN_ACCOUNT_FAILED',

  // Create Token Address Lookup Table (Solana-only)
  CREATE_TOKEN_ALT_PARAMS_INVALID: 'CREATE_TOKEN_ALT_PARAMS_INVALID',
  CREATE_TOKEN_ALT_FAILED: 'CREATE_TOKEN_ALT_FAILED',

  // Set Pool (register pool in TokenAdminRegistry)
  SET_POOL_PARAMS_INVALID: 'SET_POOL_PARAMS_INVALID',
  SET_POOL_FAILED: 'SET_POOL_FAILED',

  // Transfer Ownership (2-step pool ownership transfer)
  TRANSFER_OWNERSHIP_PARAMS_INVALID: 'TRANSFER_OWNERSHIP_PARAMS_INVALID',
  TRANSFER_OWNERSHIP_FAILED: 'TRANSFER_OWNERSHIP_FAILED',

  // Accept Ownership (2-step pool ownership acceptance)
  ACCEPT_OWNERSHIP_PARAMS_INVALID: 'ACCEPT_OWNERSHIP_PARAMS_INVALID',
  ACCEPT_OWNERSHIP_FAILED: 'ACCEPT_OWNERSHIP_FAILED',

  // Execute Ownership Transfer (Aptos 3rd step — owner finalizes transfer)
  EXECUTE_OWNERSHIP_TRANSFER_PARAMS_INVALID: 'EXECUTE_OWNERSHIP_TRANSFER_PARAMS_INVALID',
  EXECUTE_OWNERSHIP_TRANSFER_FAILED: 'EXECUTE_OWNERSHIP_TRANSFER_FAILED',

  // Contract Verification
  CONTRACT_VERIFICATION_ERROR: 'CONTRACT_VERIFICATION_ERROR',
  CONTRACT_VERIFICATION_FAILED: 'CONTRACT_VERIFICATION_FAILED',
  VERIFICATION_CONTRACT_UNKNOWN: 'VERIFICATION_CONTRACT_UNKNOWN',
