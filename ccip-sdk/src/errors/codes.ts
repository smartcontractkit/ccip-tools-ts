...
export const CCIPErrorCode = {
  ...
  PARTIAL_TRANSACTION_SUBMISSION: 'PARTIAL_TRANSACTION_SUBMISSION',
  ...
  LANE_LATENCY_INSUFFICIENT_DATA: 'LANE_LATENCY_INSUFFICIENT_DATA',

  // Commit & Merkle
  COMMIT_NOT_FOUND: 'COMMIT_NOT_FOUND',
  COMMIT_HISTORY_PRUNED: 'COMMIT_HISTORY_PRUNED',
  ...
  // Destination pool preflight (pool-direct releaseOrMint simulation)
  DEST_EXECUTION_REVERT: 'DEST_EXECUTION_REVERT',
  DEST_SIMULATION_UNAVAILABLE: 'DEST_SIMULATION_UNAVAILABLE',
  SOURCE_POOL_REVERT: 'SOURCE_POOL_REVERT',
  ...
  LOGS_STREAM_INCONSISTENT: 'LOGS_STREAM_INCONSISTENT',
  ...
  CCT_TOKEN_ACCOUNT_MINT_MISMATCH: 'CCT_TOKEN_ACCOUNT_MINT_MISMATCH',
  CCT_TX_FAILED: 'CCT_TX_FAILED',
  CCT_TX_NOT_CONFIRMED: 'CCT_TX_NOT_CONFIRMED',
  CCT_CONTRACT_VERSION_UNSUPPORTED: 'CCT_CONTRACT_VERSION_UNSUPPORTED',
  CCT_OPERATION_UNSUPPORTED: 'CCT_OPERATION_UNSUPPORTED',
  CCT_DATA_DECODE_FAILED: 'CCT_DATA_DECODE_FAILED',
} as const
