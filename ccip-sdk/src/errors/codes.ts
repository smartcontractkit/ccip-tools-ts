...
export const CCIPErrorCode = {
  ...
  MESSAGE_NOT_COMMITTED: 'MESSAGE_NOT_COMMITTED',
  ...
  ONCHAIN_COMMIT_REQUIRED: 'ONCHAIN_COMMIT_REQUIRED',
...
export const TRANSIENT_ERROR_CODES = new Set<CCIPErrorCode>([
  ...
  CCIPErrorCode.MESSAGE_NOT_COMMITTED,
  CCIPErrorCode.API_REQUIRED,
])
