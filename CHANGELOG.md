...
- CLI: when an RPC reports a chain id missing from the selector table, "No RPC found" and "Transaction not found" errors name it and the `--chain-selectors` value to pass
