...
// Per-chain public endpoint groups, overridable via the RPC_* env vars.
//
// Every e2e invocation passes ONLY the endpoints of the chains its fixture
// lives on (see buildShowArgs/buildLaneArgs): the CLI races `--rpc` endpoints
// per family, and an endpoint that never answers stalls every "not found on
// any chain" determination until it does — so racing twenty endpoints per
...
export const FUJI_RPCS = [process.env['RPC_AVAX'] || 'https://api.avax-test.network/ext/bc/C/rpc']
...
export const APTOS_TESTNET_RPCS = [
...
export const SOLANA_DEVNET_RPCS = [
...
export const TON_TESTNET_RPCS = [process.env['RPC_TON'] || 'https://testnet.toncenter.com/api/v2']
...
export const BASE_MAINNET_RPCS = [process.env['RPC_BASE'] || 'https://mainnet.base.org']
export const POLYGON_MAINNET_RPCS = [
...
export const GNOSIS_MAINNET_RPCS = [process.env['RPC_GNOSIS'] || 'https://rpc.gnosischain.com']
export const ETHEREUM_MAINNET_RPCS = [
...
export const ROBINHOOD_TESTNET_RPCS = [
