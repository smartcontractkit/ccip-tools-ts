...
const BYTECODE_LOADERS: Record<string, () => Promise<string>> = {
  CrossChainToken: async () =>
    (await import('@chainlink/ccip-sdk/src/cct/evm/token/bytecodes/CrossChainToken.ts'))
      .CROSS_CHAIN_TOKEN_BYTECODE,
  CrossChainPoolToken: async () =>
    (await import('@chainlink/ccip-sdk/src/cct/evm/token/bytecodes/CrossChainPoolToken.ts'))
      .CROSS_CHAIN_POOL_TOKEN_BYTECODE,
  BurnMintTokenPool: async () =>
    (await import('@chainlink/ccip-sdk/src/cct/evm/token-pool/bytecodes/BurnMintTokenPool.ts'))
      .BURN_MINT_TOKEN_POOL_BYTECODE,
  LockReleaseTokenPool: async () =>
    (await import('@chainlink/ccip-sdk/src/cct/evm/token-pool/bytecodes/LockReleaseTokenPool.ts'))
      .LOCK_RELEASE_TOKEN_POOL_BYTECODE,
  ERC20LockBox: async () =>
    (await import('@chainlink/ccip-sdk/src/cct/evm/token-pool/bytecodes/ERC20LockBox.ts'))
