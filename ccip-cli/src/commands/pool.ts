...
export const describe =
  'Pool operations (deploy, apply-chain-updates, append-remote-pool-addresses, remove-remote-pool-addresses, delete-chain-config, get-config, set-rate-limiter-config, set-rate-limit-admin, provide-liquidity, set-fee-config, set-finality-config, set-fee-admin, transfer-ownership, accept-ownership, execute-ownership-transfer)'
