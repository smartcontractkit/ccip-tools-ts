...
**Optional fields:** `jwt`, `auth`, `externalEdsUrlsByOwner`, `indexerUrl`, `chainId`, `defaultSendGasLimit`, `feeTransferFactoryAmount`, `ccvs`, `packages`
