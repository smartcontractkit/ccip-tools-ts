...
| `--router` | `-r`  | string | CCIP Router contract address on EVM source, or CCIPSender instance id on Canton source (defaults to `senderInstanceId` in canton-config) |
...
| `--canton-config`  | -                      | string   | Path to Canton config JSON file (required when source or dest is Canton). See [Configuration](/cli/configuration#canton-configuration). |
...
| Option                 | EVM→EVM                     | EVM→Solana                       | Solana→EVM     | EVM→Sui             | Canton→EVM                                               |
| ---------------------- | --------------------------- | -------------------------------- | -------------- | ------------------- | -------------------------------------------------------- |
| `--gas-limit` / `-L`   | Gas limit for `ccipReceive` | Compute units                    | Gas limit      | Gas limit           | Gas limit for dest                                       |
...
| `--ooo`                | Default: true               | Default: true                    | Default: true  | Default: true       | Default: true                                            |
| `--extra` / `-x`       | v2+ lanes only              | -                                | -              | -                   | `feeTokenHoldingCids`, `ccvRawAddresses`, `executorMode` |
| `--canton-config`      | -                           | -                                | -              | -                   | Required                                                 |
| `-r` / `--router`      | Router address              | Router address                   | Router address | Router address      | CCIPSender instance id                                   |
...
```bash
-x feeTokenHoldingCids='["#holding-cid-1"]' \
-x executorMode=none
```
