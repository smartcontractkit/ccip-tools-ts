...
| List supported tokens   | `ccip-cli getSupportedTokens <source> <router>` | [getSupportedTokens](/cli/supported-tokens) |
| Check lane latency      | `ccip-cli laneLatency <source> <dest>`          | [laneLatency](/cli/lane-latency)            |
