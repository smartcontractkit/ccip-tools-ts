...
| Send a message          | `ccip-cli send <source> <router> <dest>`                 | [send](/cli/send)                           |
...
| List supported tokens   | `ccip-cli getSupportedTokens <source> <address> [token]` | [getSupportedTokens](/cli/supported-tokens) |
