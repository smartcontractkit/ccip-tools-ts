...
The `token` command queries the balance of native tokens (ETH, SOL, APT, etc.) or ERC20/SPL tokens for a specified wallet address. It supports EVM, Solana, Aptos, and TON chains.
