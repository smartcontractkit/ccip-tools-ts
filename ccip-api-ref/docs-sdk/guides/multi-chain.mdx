...
<Tabs>
<TabItem value="evm-evm" label="EVM → EVM">
...
<TabItem value="evm-solana" label="EVM → Solana">
...
<TabItem value="evm-aptos" label="EVM → Aptos">
...
When sending **data + tokens** to Solana, `tokenReceiver` is required — it must be the Solana wallet or PDA that will receive the tokens. See [Build CCIP messages to Solana](https://docs.chain.link/ccip/tutorials/svm/destination/build-messages) for full details on `accounts`, `accountIsWritableBitmap`, and `computeUnits`.
...
See [Build CCIP messages from Solana](https://docs.chain.link/ccip/tutorials/svm/source/build-messages) for full details.
...
See [Build CCIP messages to Aptos](https://docs.chain.link/ccip/tutorials/aptos/destination/build-messages) for details on receiver addressing, resource accounts, and programmable token transfers.
...
See [Build CCIP messages from Aptos](https://docs.chain.link/ccip/tutorials/aptos/source/build-messages) for full details.
