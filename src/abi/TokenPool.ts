export default [
  // generate:
  // fetch('https://raw.githubusercontent.com/smartcontractkit/chainlink-ccip/refs/tags/contracts-ccip-v1.6.0/chains/evm/gobindings/generated/v1_5_1/token_pool/token_pool.go')
  //   .then((res) => res.text())
