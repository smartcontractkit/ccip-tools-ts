// generate:
// fetch('https://github.com/smartcontractkit/chainlink-ccip/raw/refs/heads/main/chains/solana/contracts/target/types/cctp_token_pool.ts')
//   .then((res) => res.text())
//   .then((text) => text.trim())
    ...
    },
    {
      ...
      accounts: [
        ...
        },
        {
          ...
          isMut: true
          isSigner: false
          docs: ['CHECK this is not read by the pool, just forwarded to CCTP']
        },
        {
    ...
    },
    {
      ...
      accounts: [
        ...
        },
        {
          ...
          isMut: true
          isSigner: false
          docs: ['to be a particular fund reclaimer']
        },
        {
          name: 'authority'
          isMut: true
